...
Below code chunks create new columns of total water point count, functional/non-functional and unknown water points count by using *st_intersects()* function.
